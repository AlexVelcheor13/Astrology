...
func (a ApodPostgres) InsertApod(c *gin.Context, am *beteraAstrology.ApodModel) (int64, error) {
...
func (a ApodPostgres) GetApodRecordByDate(date time.Time) (*beteraAstrology.ApodModel, error) {
	var apod beteraAstrology.ApodModel
...
func (a ApodPostgres) GetFullAlbum(c *gin.Context) (*[]beteraAstrology.ApodModel, error) {
	var apods []beteraAstrology.ApodModel
